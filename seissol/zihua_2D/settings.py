...
parallel_run_settings = general_settings.ParallelRunSettings(
    num_chains=2,
    chain_save_path=Path("ridgecrest_2D_T28/chain"),
    # chain_load_path=None,
    chain_load_path=Path("ridgecrest_2D_T27/chain"),
    node_save_path=Path("ridgecrest_2D_T28/final_node"),
    node_load_path=Path("ridgecrest_2D_T27/final_node"),
    # node_load_path=None,
    rng_state_save_path=Path("ridgecrest_2D_T28/rng_state"),
    rng_state_load_path=Path("ridgecrest_2D_T27/rng_state"),
...
logger_settings = general_settings.LoggerSettings(
    do_printing=True,
    logfile_path=Path("ridgecrest_2D_T28") / Path("mtmlda"),
    debugfile_path=Path("ridgecrest_2D_T28") / Path("mtmlda_debug"),
    write_mode="w",
)
...
sampler_component_settings = builder.SamplerComponentSettings(
    ...
    proposal_covariance=np.diag((np.square(3.0), np.square(1.0))),
    proposal_rng_seed=4,
